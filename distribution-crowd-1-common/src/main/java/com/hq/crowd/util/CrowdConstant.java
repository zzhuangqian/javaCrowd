...
public class CrowdConstant {
    ...
    public static final String ATTR_NAME_LOGIN_ADMIN="LOGIN_ADMIN";

    public static final String ATTR_NAME_PAGE_INFO = "PAGE-INFO";

    public static final String MESSAGE_LOGIN_FAILD= "登录账号或密码不正确！请核对后再登录";

    public static final String MESSAGE_LOGIN_INVALID = "明文不是有效字符串，请核对后再操作";
    public  static final String MESSAGE_ACCESS_DENIED = "请登录后再操作";

    public static final String MESSAGE_LOGIN_ACCT_ALREADY_IN_USE = "登录帐号被占用，请重新设定！";
